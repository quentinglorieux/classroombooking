...
// Date
$field = 'date';
$label = form_label(lang('bookings_date'), 'date');
...
// Period
$field = 'period_id';
$label = form_label(lang('bookings_period'), $field);
...
// Room
$field = 'room_id';
$label = form_label(lang('bookings_room'), $field);
if ($is_admin) {
...
if ($is_admin) {
	...
	$label = form_label(lang('bookings_recurring'), 'recurring');
	...
	$input_label = form_label($input . lang('bookings_recurring_yes'), 'recurring', ['class' => 'ni']);
...
$submit_single = form_button([
    ...
    'name' => 'action',
    'value' => 'create',
    'content' => lang('bookings_create_booking'),
]);
...
$submit_recurring = form_button([
    ...
    'content' => lang('bookings_preview_recurring'),
]);


$cancel = anchor($return_uri, lang('bookings_cancel'), ['up-dismiss' => '']);
