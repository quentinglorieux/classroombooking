			...
			<div class="block-group">
				...
				<div class="block b-50 header-meta">
					...
					if ($this->userauth->logged_in()) {
						...
						echo sprintf('<p class="normal">' . lang('logged_in_as') . '</p>', html_escape($label));
						?>
						<div class="language-selector">
							<a href="<?php echo site_url('language/switch/english'); ?>">English</a> |
							<a href="<?php echo site_url('language/switch/french'); ?>">Français</a>
						</div>
						<?php
					}
				...
				<div class="block-group">
					...
					<div class="block b-40">
						<div style="font-size:90%;color:#678; line-height: 2; text-align:right">
							...
							<br>
							&copy; <?= date('Y') ?> Craig A Rodway. Tuned by QG.</span>
							<br />
